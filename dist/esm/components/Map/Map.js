...
var Map = forwardRef(function (_a, ref) {
    ...
    return (_jsx("div", { ref: containerRef, className: "fabric-map ".concat(className), style: __assign({ width: width, height: height, position: 'relative', overflow: 'hidden' }, style), children: children }));
});
Map.displayName = 'Map';
export { Map };
export default Map;
