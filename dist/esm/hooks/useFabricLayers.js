...
export var useFabricLayers = function () {
    var _a = useLayerManager(), canvas = _a.canvas, layerManager = _a.layerManager;
    ...
    var onObjectAdded = useCallback(function (callback) {
        callbacks.current.onObjectAdded = callback;
    }, []);
    var onObjectRemoved = useCallback(function (callback) {
        callbacks.current.onObjectRemoved = callback;
    }, []);
    var onSelectionCreated = useCallback(function (callback) {
        callbacks.current.onSelectionCreated = callback;
    }, []);
    var onSelectionCleared = useCallback(function (callback) {
